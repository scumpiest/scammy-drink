...
var chat_templates: Dictionary = {
	...
	"seal_wrong_ingredient": "Cause idk, I'm pretty sure you don't normally put {ingredient} in there…",
	...
	"seal_thx_bad": "Welp, it's not that good, but don't you worry, you'll get there soon enough!",
	
	# Fish
	"fish_hello": "Hi.",
	"fish_my_drink?": "Mine?",
	"fish_wrong_ingredient": "No …!",
	"fish_right_ingredient": "…!",
	"fish_thx_1": "Thank…",
	...
	"shark_thx_2": "Uh, yes, this is fine I guess, but let me just mix it myself next time!",
	"shark_thx_3": "Wait, what, this is ALMOST as good as when I do it! Almost!",
	"shark_thx_bad": "Ew, what is this? I'm not drinking this!",
	
	# Axolotl
	"axolotl_hello": "Greetings!",
	"axolotl_my_drink?": "I assume you are making my drink, as I just ordered.",
	"axolotl_wrong_ingredient": "So, I don't want to be mean at all, but you know that mixing {ingredient} in there leaves you with a weird taste, right?",
	"axolotl_right_ingredient": "Ummm, actually the drink I ordered has {ingredient} in it, so make sure you don't forget that!",
